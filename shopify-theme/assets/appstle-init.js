(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0668/2669/9053/t/10/assets/appstle-subscription.js?v=1682357657");
      ...
      RS.Config = {
        ...
        "atcButtonSelector": "#shopify-block-15a7e0e8-8633-4eb6-9e32-1e4f330da79a > div > div > div.donatemate-text-grid > div > div, .product-form__buttons",
        "moneyFormat": "{% raw %}${{amount}}{% endraw %}",
        "oneTimePurchaseText": "One Time Purchase",
        "shop": "sponsor-a-pet.myshopify.com",
